...
\begin{document}
	...
	\noindent In both hierarchies, the file at the leaf is a pointer to the same data, and a user can access the same file through either one (directly through the album name, or through albums organized by year).
